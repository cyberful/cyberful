...
// A single JavaScript isolate owns these counters; each synchronous call claims
// its sequence value before control can return to another task.
let lastTimestamp = 0
let counter = 0
