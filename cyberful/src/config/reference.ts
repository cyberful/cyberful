// ── Reference Configuration Normalization ────────────────────────
// Validates named reference aliases and normalizes shorthand, local paths, and Git
// objects into explicit variants consumed by the reference cache.
// → cyberful/src/reference/reference.ts — resolves normalized entries for a project.
// ─────────────────────────────────────────────────────────────────
