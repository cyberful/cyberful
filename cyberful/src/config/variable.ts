...
// Expands environment and file tokens in JSONC text, resolves file paths relative
// to their source, and reports missing references without altering comment tokens.
// → cyberful/src/config/config.ts — validates the expanded text as runtime config.
// ─────────────────────────────────────────────────────────────────
