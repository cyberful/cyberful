// ── Effect Log Adapter ─────────────────────────────────────────────
// Converts Effect log messages, annotations, spans, and causes into Cyberful's
// local structured logger without adding a network or telemetry transport.
// → cyberful/src/util/log.ts — owns the local log sinks and formatting.
// ────────────────────────────────────────────────────────────────────
