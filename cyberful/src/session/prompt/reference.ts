...
// Validates reference metadata and renders resolved or invalid references into prompt parts.
// → cyberful/src/reference/reference.ts — resolves the local or Git targets rendered here.
// → cyberful/src/session/prompt.ts — inserts the resulting parts into user messages.
// ─────────────────────────────────────────────────────────────────────
