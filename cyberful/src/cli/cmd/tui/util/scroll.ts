// ── Configured Scroll Acceleration ───────────────────────────────
// Chooses platform acceleration or a constant-speed implementation from validated
//   TUI settings and supplies a stable default when neither is configured.
// ─────────────────────────────────────────────────────────────────
