// ── Transcript Export Options Dialog ─────────────────────────────
// Collects filename, reasoning, tool detail, metadata, and open-only choices and
//   returns one normalized export request after explicit confirmation.
// ─────────────────────────────────────────────────────────────────
...
export function DialogExportOptions(props: DialogExportOptionsProps) {
  ...
  const [store, setStore] = createStore<{
    ...
    assistantMetadata: boolean
    openWithoutSaving: boolean
    active: "filename" | "thinking" | "toolDetails" | "assistantMetadata" | "openWithoutSaving"
  }>({
