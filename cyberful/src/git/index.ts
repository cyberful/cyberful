// ── Bounded Git Command Service ──────────────────────────────────
// Runs Git without optional locks and converts status, diff, patch, and branch
// output into stable typed values for project and reporting workflows.
// → cyberful/src/effect/process.ts — enforces subprocess capture and output bounds.
// → cyberful/src/reference/repository-cache.ts — uses this service for isolated cached clones.
// ─────────────────────────────────────────────────────────────────
...
export class Service extends Context.Service<Service, Interface>()("@cyberful/Git") {}
