// ── Public Control-Plane Error Contracts ────────────────────────
// Defines the typed, status-bearing failures returned by HTTP handlers and the
// constructors that translate internal missing-resource failures at the API boundary.
// → cyberful/src/server/routes/instance/httpapi/handlers/session-errors.ts — maps session failures.
// ─────────────────────────────────────────────────────────────────
