...
// Declares directory-routed project listing, lookup, update, and current-project
// routes with explicit missing-project and invalid-request failures.
// → cyberful/src/server/routes/instance/httpapi/handlers/project.ts — implements project operations.
// ─────────────────────────────────────────────────────────────────
      ...
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with Cyberful.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the currently active project that Cyberful is working with.",
          }),
        ),
