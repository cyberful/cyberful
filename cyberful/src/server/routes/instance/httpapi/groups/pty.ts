// ── PTY Endpoint And WebSocket Contracts ────────────────────────
// Declares terminal creation, inspection, update, removal, and ticketed socket
// connection routes for one directory-routed instance.
// → cyberful/src/server/routes/instance/httpapi/handlers/pty.ts — owns PTY execution and sockets.
// ─────────────────────────────────────────────────────────────────
      ...
      .add(
        ...
        HttpApiEndpoint.get("list", PtyPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all active pseudo-terminal (PTY) sessions managed by Cyberful.",
          }),
        ),
