// ── Bounded HTTP Response Compression ───────────────────────────
// Compresses eligible non-streaming byte responses above the size threshold,
// respecting content type, cache-control, and accepted encoding semantics.
// → cyberful/src/server/routes/instance/httpapi/server.ts — installs this global middleware.
// ─────────────────────────────────────────────────────────────────
