...
export type FindingRun = {
  id: string
  workflow: "pentest" | "bug-bounty" | "code-audit"
  startedAt: string
  endedAt?: string
  status: "RUNNING" | "COMPLETED" | "BLOCKED" | "FAILED" | "INTERRUPTED"
}

export type FindingVerification = {
  result: "NOT_REVIEWED" | "SURVIVES" | "REVISE" | "DEMOTE"
  rationale?: string
}

export type FindingSubmission = {
  result: "NOT_ASSESSED" | "SUBMISSION_READY" | "NEEDS_MORE_EVIDENCE" | "NOT_REPORTABLE"
  rationale?: string
}
...
export type FindingRegistry = {
  schema_version: 1
  revision: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
  runs: Array<FindingRun>
  findings: Array<WorkareaFinding>
}

export type FindingRegistryView = {
  workarea: string
  runID: string
...
export type EventFindingRegistryUpdated = {
  id: string
...
export type SessionFindingsData = {
  body?: never
  path: {
    sessionID: string
  }
...
export type SessionFindingsErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type SessionFindingsError = SessionFindingsErrors[keyof SessionFindingsErrors]

export type SessionFindingsResponses = {
  /**
   * Workarea finding registry
   */
  200: FindingRegistryView
}
