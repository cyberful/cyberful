...
import type { ClientMeta } from "./core/types.gen"
import type { ServerSentEventsResult } from "./core/serverSentEvents.gen"
import type { Client, Options as Options2, RequestResult, TDataShape } from "./client/types.gen"
...
import type {
  ...
  SessionFindingsErrors,
  SessionFindingsResponses,
  SessionForkErrors,
...
export class Runtime extends HeyApiClient {
  ...
  public status<ThrowOnError extends boolean = false>(
    ...
    options?: Options<never, ThrowOnError>,
  ): RequestResult<RuntimeStatusResponses, RuntimeStatusErrors, ThrowOnError> {
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "directory" }] }])
...
export class Session extends HeyApiClient {
   ...
   *
   * Resolve the session workarea and return its authoritative cross-run finding registry.
   */
  public findings<ThrowOnError extends boolean = false>(
    ...
    options?: Options<never, ThrowOnError>,
  ): RequestResult<SessionFindingsResponses, SessionFindingsErrors, ThrowOnError> {
    const params = buildClientParams(
      [parameters],
      [
        {
...
export class ControlPlaneClient extends HeyApiClient {
  public static readonly __registry: HeyApiRegistry<ControlPlaneClient> = new HeyApiRegistry<ControlPlaneClient>()
