...
- Index the full in-scope snapshot with `code_graph_index`. The current built-in registry uses deterministic
...
critical cross-language boundaries, and unresolved gaps. Then stop.
