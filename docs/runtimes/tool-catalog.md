...
| `skill_search` | Cyberful release | Eager metadata-only progressive skill search. | Find a skill by exact or prefix name, category, capability, tag, trigger, or framework identifier before reading its complete instructions. |
